      ...
      <main className="auth-main">
        <div className="auth-card anim-fade-up">
          {!showOtp ? (
            <>
              <h3>Welcome back</h3>
              <p className="sub">Sign in to your GymStitch account</p>

              
                <Button
                variant="secondary"
                fullWidth
                className="oauth-btn w-full mb-4"
              ...
              <div className="mb-5 mt-3.5 flex items-center justify-between">
                ...
                <a href="/forgot-password" className="text-[13.5px] font-semibold text-accent">
                  Forgot password?
                </a>
              </div>
            ...
            <>
              ...
              <p className="sub">
                ...
                <b className="text-accent">{otpEmail ?? email}</b>
              </p>
              ...
              <div className="form-foot justify-center">
                <span className="muted small">
                  ...
                  <a href="#" onClick={(e) => { e.preventDefault(); onResendCode(); }}>
                    Resend code
                  </a>
                </span>
              </div>
